    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-[var(--el-green)] bg-black animate-slide-up safe-bottom">
      <div className="mx-auto max-w-5xl flex items-center justify-between px-3 py-2.5 md:px-4 md:py-3 gap-2 md:gap-3">
        ...
        <button
          ...
          className="shrink-0 border border-[var(--el-green-d9)] px-3 py-2 md:py-1.5 text-[10px] font-mono uppercase tracking-wider text-[var(--el-green-d9)] hover:border-[var(--el-green)] hover:text-[var(--el-green)] active:bg-[var(--el-green-99)] transition-all"
        >
          CANCEL
        </button>
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          {selectedCount < totalCount && (
            <button
              onClick={onSelectAll}
              className="hidden sm:block shrink-0 border border-[var(--el-green-d9)] px-3 py-2 md:py-1.5 text-[10px] font-mono uppercase tracking-wider text-[var(--el-green-d9)] hover:border-[var(--el-green)] hover:text-[var(--el-green)] active:bg-[var(--el-green-99)] transition-all"
            >
              SELECT ALL
            </button>
          )}
