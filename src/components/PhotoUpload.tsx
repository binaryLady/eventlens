      ...
      {!isActive && !uploading && (
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 border border-[var(--el-green-d9)] bg-black/60 px-4 py-2 text-xs font-mono uppercase tracking-wider text-[var(--el-green-d9)] transition-all hover:border-[var(--el-green)] hover:text-[var(--el-green)] hover:shadow-[0_0_10px_rgba(0,255,65,0.15)]"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 border border-[var(--el-green-d9)] bg-black/60 px-4 py-2 text-xs font-mono uppercase tracking-wider text-[var(--el-green-d9)] transition-all hover:border-[var(--el-green)] hover:text-[var(--el-green)] hover:shadow-[0_0_10px_rgba(0,255,65,0.15)] md:hidden"
          >
            <svg
              width="14"
              height="14"
      ...
      {(uploading || isActive) && (
        <div className="flex items-center justify-center gap-3">
          ...
          {uploading ? (
            ...
            <button
              onClick={handleClear}
              className="inline-flex items-center gap-1.5 border border-[var(--el-green-d9)] bg-black/60 px-3 py-1 text-[10px] font-mono uppercase tracking-wider text-[var(--el-green-d9)] transition-all hover:border-[var(--el-green)] hover:text-[var(--el-green)]"
            >
              <svg
                width="12"
                height="12"
